...
import { saveRepeated,saveJso,handledataforlineChart,handledataforlineChartSevenDay,update_logo,changequery,handledataforverticalChart,handlepieChart,handleDataForTable} from './components/redux/reducer'
import SideNav, {
  Toggle,
  Nav,
  NavItem,
